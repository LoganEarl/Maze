...
public class ShortResponseQuestion implements SQLiteQuestion {
    ...
    ShortResponseQuestion(int id, String[] keywords, String prompt, String keyItemName) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        ShortResponseQuestion that = (ShortResponseQuestion) o;
        return id == that.id &&
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(id, prompt, keyItemName);
